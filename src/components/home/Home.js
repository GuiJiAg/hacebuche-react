        ...
        <div className="w3-row w3-padding-64 w3-margin">
          <div className="w3-col m5 w3-container w3-center">
            <div className="w3-card w3-round w3-hover-shadow">
              <Link to="/menu" className="linkNoDecoration" onClick={() => this.props.onClickGoTop()}>
          ...
          <div className="w3-col m5 w3-container w3-center">
            <div className="w3-card w3-round w3-hover-shadow">
              <Link to="/wines" className="linkNoDecoration" onClick={() => this.props.onClickGoTop()}>
    ...
    return (
      <div className="w3-container w3-padding-64">
        <div className="w3-row">
          ...
          <div className="w3-col m5 w3-container w3-center">
            <div className="w3-card w3-round w3-hover-shadow">
              <Link to="/reserve" className="linkNoDecoration" onClick={() => this.props.onClickGoTop()}>
        ...
        <br />
        <br />
        <a id="maps" href="https://www.google.com/maps/place/Mes%C3%B3n+Hacebuche/@37.0288132,-4.5578641,12z/data=!4m5!3m4!1s0x0:0xd65ba151b9aec3ff!8m2!3d37.0165881!4d-4.5577524" target="_blank" className="linkNoDecoration">
    ...
    return (
      <div>
        ...
        <div className="w3-content">
          <About />
          <Links onClickGoTop={() => this.handlerGoTop()} />
          <Contact onClickGoTop={() => this.handlerGoTop()} />
        </div>
      </div>
    );
  }
